...
private:
    ...
    static int FIRST_SPECIFIC_FIELD_MASK = 0x007FFFFF;
...
protected:
     ...
     */
    public AbstractMessageParser(ProtocolDataUnit initProtocolDataUnit) {
     ...
     */
    void deserializeBasicHeaderSegment(ByteBuffer pdu) throws InternetSCSIException {
