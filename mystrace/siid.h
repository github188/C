...
/* header of system interrupt id */
#include <asm/unistd.h>

/* use vim substitute can translate the file /usr/include/asm/unistd_64.h to 
 * this structure fastly.
 * vim substitute command: (should delete the last backslash of the search pattern)
 *     12,325s/__NR_\(.*\) \d*\/[__NR_\1] \= "\1", /g 
 */

const char * const siid [] = {
	[__NR_read] = "read", 
	[__NR_write] = "write", 
	[__NR_open] = "open", 
	[__NR_close] = "close", 
